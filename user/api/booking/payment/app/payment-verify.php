...
if ($requestMethod == 'POST') {
    ...
    if (!empty($inputData)) {
        ...
        $bookingQuery = "SELECT * FROM online_bookings WHERE merchant_transaction_id = '$merchantTransactionId' LIMIT 1";
        ...
        if ($final['success'] === true && isset($final['data']['state']) && $final['data']['state'] === 'COMPLETED') {
