...
if ($requestMethod == 'GET') {
    ...
    $limitSql = "SELECT rt.*, tu.phone FROM `registered_theaters` rt LEFT JOIN `theater_users` tu ON rt.`name` = tu.`theater_name` $whereClause ORDER BY rt.id DESC LIMIT $limit OFFSET $offset";
